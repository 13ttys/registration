...
final class PluginExtension extends \Twig_Extension implements \Twig_Extension_GlobalsInterface
{
    ...
    public function getFilters(): array
    {
        ...
        return [
            ...
            Translator::getTwigFilterTranslate(),
        ];
    }
    ...
    public function getFunctions(): array
    {
        return [
            ...
            new \Twig_SimpleFunction("file_exists", [$this, "file_exists"], [ "needs_environment" => true ]),
        ];
    }
     ...
     * @throws \Exception
     */
    public function asset(string $path, array $query = [], bool $relative = true): string
    {
    ...
    public function file_exists(\Twig_Environment $env, string $path)
    {
